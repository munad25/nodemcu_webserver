...
const char* ssid     = "JALUK_WARA"; //Wi-Fi SSID
const char* password = "bayar5000"; //Wi-Fi Password

//Only used if using Static IP
IPAddress ip(192, 168, 100, 50); //IP
IPAddress gatewayDNS(192, 168, 100, 1);//DNS and Gewateway
...
void loop() {
  ...
  String url = "http://localhost/iotreset/"; //File or Server page you want to communicate with. along with data
